        ...
        <section id="skills" className="section-wrapper">
            ...
            <div className={styles.skills}>
                <div>
                    ...
                    <Reveal>
                        <p className={styles.skillsText}>
                            My skills revolve mainly around web development.
                            Here, I mainly use languages like JavaScript, TypeScript, Java,
                            and Python.
                    ...
                    <Reveal>
                        <p className={styles.skillsText}>
                            But my skills are not limited to the web.
                            I am also able to create engaging mobile applications
                            with React Native, where I blend functionality and aesthetics with ease.
                            Furthermore, While I have prior experience with machine learning,
                            I am continually expanding my knowledge and honing my skills in this domain.
                        </p>
                    </Reveal>
                    <Reveal>
                        <p className={styles.skillsText}>
                            Please feel free to explore my GitHub and
                            GitLab profiles below to review some of my showcased projects.
                        </p>
                    </Reveal>
                    <Reveal>
